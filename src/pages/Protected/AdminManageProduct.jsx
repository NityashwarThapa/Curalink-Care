...
const AdminManageProducts = () => {
  ...
  const [newProduct, setNewProduct] = useState({
    ...
    category: "bins", // Add category field here
    image: null,
    description: "",
  });
  ...
  const openModal = (product = null) => {
    if (product) {
      ...
      setNewProduct({
        ...
        dosage: "",
        requiresPrescription: false,
        category: "bins", // Reset category to empty when adding new product
        image: null,
        description: "",
      });
    }
  ...
  const categoryOptions = [
    { _id: '1', name: 'Pain Relief' },
    { _id: '2', name: 'Antibiotics' },
    { _id: '3', name: 'Vitamins & Supplements' },
    { _id: '4', name: 'Skin Care' },
    { _id: '5', name: 'Cold & Flu' },
    { _id: '6', name: 'Digestive Health' },
    { _id: '7', name: 'Heart Care' },
    { _id: '8', name: 'Diabetes Care' },
  ];
